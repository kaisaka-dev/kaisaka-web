...
describe('ServiceCategoryModel', () => {
    ...
    it('insertServiceCategory should return inserted category on success', async () => {
        ...
        (ServiceCategoryModel.instance as any).insertOne = mockInsert;

        const result = await ServiceCategoryModel.instance.insertServiceCategory('Category');
    ...
    it('getAll should return list of categories when found', async () => {
        ...
        (ServiceCategoryModel.instance as any).findMany = mockFindMany;

        const result = await ServiceCategoryModel.instance.getAll();
        expect(result).toEqual([sampleCategory]);
    });
    ...
    it('findById should return category when found', async () => {
        ...
        (ServiceCategoryModel.instance as any).findOne = mockFindOne;

        const result = await ServiceCategoryModel.instance.findById(1);
    ...
    it('findById should return null when not found', async () => {
        ...
        const result = await ServiceCategoryModel.instance.findById(999);
        expect(result).toBeNull();
    });
    ...
    it('findByName should return list when match found', async () => {
        ...
        const result = await ServiceCategoryModel.instance.findByName('Health Support');
    ...
    it('findByName should return null when no matches found', async () => {
        ...
        const result = await ServiceCategoryModel.instance.findByName('Unknown');
        expect(result).toBeNull();
    });
    ...
    it('updateName should return true on success', async () => {
        ...
        (ServiceCategoryModel.instance as any).updateOne = mockUpdate;

        const result = await ServiceCategoryModel.instance.updateName(1, 'New Name');
    ...
    it('deleteById should return true when deletion is successful', async () => {
        ...
        (ServiceCategoryModel.instance as any).deleteOne = mockDelete;

        const result = await ServiceCategoryModel.instance.deleteById(1);
    ...
    it('deleteByName should return true when deletion is successful', async () => {
        ...
        const result = await ServiceCategoryModel.instance.deleteByName('Education');
    ...
    it('deleteByName should return false when no matching record is found', async () => {
        ...
        const result = await ServiceCategoryModel.instance.deleteByName('Nonexistent');
        expect(result).toBe(false);
    });
    */
});